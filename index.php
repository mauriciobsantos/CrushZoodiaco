...
//echo('<pre>');
    ...
    $pessoas[] = [
		...
		"masculino" => false,
		"descricao" => "Uma pessoa muito regrada, centrada. Defende a moral e os bons costumes sempre que pode.",
		"sonho" => "ter o certificado da Digital House",
		"amiga" => true
    ];
...
<body>
    <header style="background-image:url(./assets/img/banner-<?php echo $pessoa['id']?>.jpge)";>
    ...
    <main>
        ...
        <section class="card teal">
            <div class="card-content white-text">
                <div class="dados">
                    ...
                    <div>
                        <span>Signo:</span>
                        <Span><?php echo $idSigno['signos'] ?></Span>
                    </div>
                    <div class="dados">
                        <span class="card-title">Sonhos</span>
                        <div>
        ...
        <section class="card" id="horoscopo">
            <div class="card-content">
                <span class="card-title">Hosróscopo</span>
